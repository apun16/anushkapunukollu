...
const sampleBooks: Book[] = [
  {
    ...
    rating: 5,
    lastRead: "2026-01-13",
    tldr: "A mathematician's critique of the education system and how it fails to teach students the beauty of mathematics.",
    annotations: "",
    imageSrc: "/books/AMathematiciansLament.jpg",
    pages: 25, 
  },
  {
    id: 2,
    ...
    rating: 3,
    lastRead: "2026-01-12",
    tldr: "A critique of how global corporate power and American military interventionism collaborate to exploit the poor, arguing that ordinary people must resist this Empire to reclaim democracy and justice.",
    annotations: "",
    imageSrc: "/books/AnOrdinaryPersonsGuidetoEmpire.jpg",
    pages: 200, 
  },
  {
    id: 3,
    ...
    rating: 4,
    lastRead: "2026-01-03",
    tldr: "During the British colonial period in India, Sea of Poppies follows a group of strangers whose lives intersect on a ship transporting labourers. It explores how empires, the opium trade, and class impacted ordinary people during that time.",
  ...
  },
  {
    ...
    rating: 5,
    lastRead: "2025-12-27",
    tldr: "Set during the Syrian civil war where 18 year old Salama Kassab, a pharmacy student, balances hope, guilt and survival while working in a hospital filled with violence.",
